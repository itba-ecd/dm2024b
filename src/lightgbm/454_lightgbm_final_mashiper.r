...
PARAM$finalmodel$num_iterations <- 114
PARAM$finalmodel$learning_rate <- 0.215838098449961
PARAM$finalmodel$feature_fraction <- 0.374706085269487
PARAM$finalmodel$min_data_in_leaf <- 674
PARAM$finalmodel$num_leaves <- 64
PARAM$finalmodel$max_bin <- 31
PARAM$finalmodel$max_depth  <- 6
PARAM$finalmodel$lambda_l1  <- 0.298277205510128
PARAM$finalmodel$lambda_l2  <- 0.195278883702559
PARAM$finalmodel$min_gain_to_split  <- 0.00134928659003121
