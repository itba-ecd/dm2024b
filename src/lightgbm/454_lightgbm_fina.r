...
PARAM$finalmodel$num_iterations <- 664
PARAM$finalmodel$learning_rate <- 0.0284488189615826
PARAM$finalmodel$feature_fraction <- 0.431672254266496
PARAM$finalmodel$min_data_in_leaf <- 1336
